                            ...
                            <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                                ...
                                <div class="dataTable-container">
                                    <table class="table table-striped dataTable-table" id="table2">
                                        <thead>
                                        <tr>
                                            <th data-sortable="" style="width: 12.8716%;">
                                                <a >考试编号</a>
                                            </th>
                                        ...
                                        <c:forEach var="score" items="${scores}" varStatus="status" >
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="managerGradeUpdate.jsp?examNum=${score.examNum}" class="badge bg-warning">修改</a>
                                                </td>
                                                <td>
                                                    <a href="delGrade?examNum=${score.examNum}" class="badge bg-danger">删除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
